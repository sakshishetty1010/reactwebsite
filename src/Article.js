...
import pp from './imgs/profilepic1.png';

export const Article = ({ headline, content }) => {
    return (
        <div>
            <div className="bg ">
                <div className="row "><img src={img} alt="" /></div>
                <div className="row">
                    <div className="category m-3 "><span> ✍️ Article</span></div>
                </div>
                ...
                <div className="row bottom ms-3 mt-4 ">
                    <div className="col-8 profile">
                        ...
                        <div className="userName">Sarthak Kamra</div>
                    </div>
